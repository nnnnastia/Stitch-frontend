...
const FAQ_ITEMS = [
    {
        ...
        answer:
            "Ми пропонуємо доставку Новою поштою, Укрпоштою та Meest. Конкретні способи доставки залежать від продавця і вказуються в картці товару.",
    },
    {
        id: 2,
    ...
    },
    {
        ...
        answer:
            "Деякі продавці можуть здійснювати міжнародну доставку. Це вказується в описі товару або в профілі продавця.",
    },
    {
        id: 7,
